# Purpose: Simulate a synthetic multimorbidity dataset with cluster-specific onset distributions, 
# condition-specific diagnosis delays, and censoring for presence-focused experiments. 
