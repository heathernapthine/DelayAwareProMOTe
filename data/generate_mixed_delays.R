# Purpose: Simulate a large synthetic multimorbidity dataset with cluster-specific onset ages and condition-specific 
# diagnosis delays (gaussian, uniform, mixture2), including censoring and delay priors for inference. 
